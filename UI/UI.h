...
public:
	...
	void Updateselected(ActionType xx);
	void ClearStatusBar() const;		//Clears the status bar
	void ClearDrawingArea() const;	//Clears the drawing area

		
	// Draws 2-input AND gate
	void DrawAND2(const GraphicsInfo &r_GfxInfo, bool selected) const;
	void DrawOR2(const GraphicsInfo& r_GfxInfo, bool selected) const;
	void DrawXOR2(const GraphicsInfo& r_GfxInfo, bool selected) const;
	void DrawNAND2(const GraphicsInfo& r_GfxInfo, bool selected) const;
	void DrawNOR2(const GraphicsInfo& r_GfxInfo, bool selected) const;
	void DrawXNOR2(const GraphicsInfo& r_GfxInfo, bool selected) const;
	void DrawINV(const GraphicsInfo& r_GfxInfo, bool selected) const;
	void DrawLED(const GraphicsInfo& r_GfxInfo, bool selected) const;
	...
	void DeleteGate(const GraphicsInfo& r_GfxInfo) const;
	void UI::DeleteConn(const GraphicsInfo& r_GfxInfo);
	void setAppMode(MODE m1);
	MODE getAppMode();
